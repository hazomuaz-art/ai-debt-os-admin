    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4">
        {[
          ...
          <div
            key={label}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-medium text-[#5f6b7e]"
        ...
        <div className="ms-auto flex items-center gap-3">
          ...
          {[
            ...
            <div key={label} className="flex items-center gap-1 text-[9px] text-[#5f6b7e]">
              <div
              ...
              <div>
                <div className="font-bold text-[#5f6b7e]">{label}</div>
                <div>{sub}</div>
              </div>
            </div>
          ))}
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-xs font-bold text-[#8b95a7]">AI</span>
            <span className="text-xs font-bold" style={{ color: '#818cf8' }}> DEBT OS</span>
            <span className="text-[10px] text-[#5f6b7e] ms-2">® Smarter Collections. Healthier Cashflow.</span>
          </div>
        </div>
