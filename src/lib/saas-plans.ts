...
export const PLAN_DEFINITIONS: Record<PlanName, PlanDefinition> = {
  ...
  business: {
    ...
    limits: {
      ...
      max_campaigns: 5, monthly_imports: 20, storage_gb: 10, voice_minutes_month: 0,
    },
    features: {
  ...
  enterprise: {
    ...
    limits: {
      ...
      max_campaigns: 50, monthly_imports: 200, storage_gb: 100, voice_minutes_month: 0,
    },
    features: {
      ai_scoring: true, ai_actions: true, whatsapp: true,
      voice: false, campaigns: true, api_access: true,
