...
8. 🔴 ${prevOutbound.length === 0 ? 'هذه أول رسالة ترسلها لهذا العميل — يجوز ذكر اسمه مرة واحدة فقط هنا.' : 'سبق أن أرسلت لهذا العميل رسائل قبل — ممنوع ذكر اسمه إطلاقاً في ردك الآن، خاطبه مباشرة بدون اسم.'}
